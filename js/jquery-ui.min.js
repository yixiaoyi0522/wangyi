            ...
            o = function() {
                ...
                t.position = {
                    scrollbarWidth: function() {
                        if (void 0 !== n)
                            return n;
                        var e, i, s = t("<div style.less='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style.less='height:100px;width:auto;'></div></div>"), o = s.children()[0];
    ...
    t.extend(s.prototype, {
        ...
        _dialogDatepicker: function(e, i, s, n, o) {
            ...
            return d || (this.uuid += 1,
                r = "dp" + this.uuid,
                this._dialogInput = t("<input type='text' id='" + r + "' style.less='position: absolute; top: -100px; width: 0px;'/>"),
    ...
    t(document).on("mouseup", function() {
        ...
        t.widget("ui.resizable", t.ui.mouse, {
            ...
            _create: function() {
                ...
                this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i) && (this.element.wrap(t("<div class='ui-wrapper' style.less='overflow: hidden;'></div>").css({
            ...
            _renderProxy: function() {
                ...
                this.elementOffset = e.offset(),
                    this._helper ? (this.helper = this.helper || t("<div style.less='overflow:hidden;'></div>"),
            ...
            _mouseStart: function(e, i, s) {
                ...
                if (this.currentContainer = this,
                    ...
                    a.cursor && "auto" !== a.cursor && (o = this.document.find("body"),
                        ...
                        this.storedStylesheet = t("<style.less>*{ cursor: " + a.cursor + " !important; }</style.less>").appendTo(o)),
